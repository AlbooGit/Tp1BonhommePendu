...
namespace TP1PROF
{
  ...
  {    
    ...
    private int[,] elements = null;//new int[Game.VERTICAL_BLOCK_COUNT, Game.HORIZONTAL_BLOCK_COUNT];
    ...
    public bool LoadFromMemory(string fileContent)
    {
      ...
      // ppoulin
      // Code à compléter pour extraire les informations du fichier de niveau.


      // N'oubliez pas de décommenter les tests appropriés dans le fichier TestsGrid du projet TP1Tests
